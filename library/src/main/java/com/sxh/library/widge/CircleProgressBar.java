...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        textSize = array.getDimension(R.styleable.CircleProgressBar_circle_text_size,textSize);
        textColor = array.getColor(R.styleable.CircleProgressBar_circle_text_color,textColor);
        centerText = array.getString(R.styleable.CircleProgressBar_circle_text)==null?centerText:array.getString(R.styleable.CircleProgressBar_circle_text);
        strokeWidth = array.getInteger(R.styleable.CircleProgressBar_circle_stroke_width,strokeWidth);
        normalColor = array.getColor(R.styleable.CircleProgressBar_circle_normal_color,normalColor);
        progressColor = array.getColor(R.styleable.CircleProgressBar_circle_progress_color,progressColor);
        progress = array.getInt(R.styleable.CircleProgressBar_circle_progress,progress);
        progress_style = array.getInt(R.styleable.CircleProgressBar_circle_progress_style,0)==0?Paint.Style.STROKE:Paint.Style.FILL;
